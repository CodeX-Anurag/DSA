...
// /* Decimal to Binary Conversion using Bitwise Operators
  ...
  /* Let's say we have a decimal number n = 5.
   
   Binary representation of 5 is 101.
   
   We can use bitwise operators to convert decimal to binary.
   
   Steps:
   1. Initialize ans = 0 and i = 0.
   2. While n is not zero:
      a. Get the last bit using n & 1.
      b. Update ans = (bit * pow(10, i)) + ans.
...
/* Binary to Decimal Conversion using Bitwise Operators
